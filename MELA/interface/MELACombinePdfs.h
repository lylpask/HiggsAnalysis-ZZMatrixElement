...
public:
	MELAqqZZPdf_v2() {} ;
	MELAqqZZPdf_v2(const char *name, const char *title,
			   RooAbsReal& _m4l,
			   RooAbsReal& _a0,
			   RooAbsReal& _a1,
			   RooAbsReal& _a2,
...
public:
  MELAggZZPdf_v2() {};
  MELAggZZPdf_v2(const char *name, const char *title,
    RooAbsReal& _m4l,
    RooAbsReal& _a0,
    RooAbsReal& _a1,
    RooAbsReal& _a2,
...
public:
  MELADoubleCB();
  MELADoubleCB(const char *name, const char *title,
    RooAbsReal& _x,
    RooAbsReal& _mean,
    RooAbsReal& _width,
    RooAbsReal& _alpha1,
...
public:
  MELARelBWUFParam() {};
  MELARelBWUFParam(const char *name, const char *title,
    RooAbsReal& _m4l,
    RooAbsReal& _mH,
