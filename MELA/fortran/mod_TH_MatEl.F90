...
SUBROUTINE EvalXSec_PP_TH(Mom,TopDecays,Channel,Res)
implicit none
...
integer, parameter :: inLeft=1,inRight=2,Hbos=3,t=4, qout=5, b=6,W=7,lep=8,nu=9
      ...
      if( Channel.eq.1 .or. Channel.eq.0 ) then
          call EvalAmp_QB_TH(Mom,TopDecays,LO_Res_Unpol)      
      ...
      if( Channel.eq.2 .or. Channel.eq.0 ) then
          call EvalAmp_QQB_THBBAR(Mom,TopDecays,LO_Res_Unpol)
          Res = Res &
...
SUBROUTINE EvalXSec_PP_TbH(Mom,TopDecays,Channel,Res)
implicit none
...
integer, parameter :: inLeft=1,inRight=2,Hbos=3,t=4, qout=5, b=6,W=7,lep=8,nu=9
      ...
      Res = 0d0
      if( Channel.eq.1 .or. Channel.eq.0 ) then
          call EvalAmp_QbarBbar_TbarH(Mom,TopDecays,LO_Res_Unpol)
      ...
      if( Channel.eq.2 .or. Channel.eq.0 ) then
          call EvalAmp_QQB_TBARHB(Mom,TopDecays,LO_Res_Unpol)
          Res = Res &
...
SUBROUTINE EvalAmp_QB_TH(MomExt,TopDecays,LO_Res_Unpol)
implicit none
integer :: TopDecays! 0=stable, 1=di-leptonic
...
! t-channel 
! MARKUS: changed MomExt(1:4, inLeft/inRight) to all outgoing   
SUBROUTINE EvalAmp_QbarBbar_TbarH(MomExt,TopDecays,LO_Res_Unpol)
implicit none
integer :: TopDecays! 0=stable, 1=di-leptonic
real(8) :: MomExt(1:4,1:9),MomExtFlat(1:7,1:4),p4Dp5,p4Dp7,LO_Res_UnPol(-6:6,-6:6),s(10,10),p2Dp3,MomExtFlatDK(1:10,1:4)
complex(8) :: za(10,10),zb(10,10),LOAmp(-6:6,-6:6,1:2),decay_amp(1:2)
...
! s-channel 
! MARKUS: changed MomExt(1:4, inLeft/inRight) to all outgoing   
SUBROUTINE EvalAmp_QQB_THBBAR(MomExt,TopDecays,LO_Res_Unpol)
implicit none
integer :: TopDecays! 0=stable, 1=di-leptonic
real(8) :: MomExt(1:4,1:9),MomExtFlat(1:7,1:4),p4Dp5,p4Dp7,LO_Res_UnPol(-6:6,-6:6),s(10,10),p2Dp3,MomExtFlatDK(1:10,1:4)
complex(8) :: za(10,10),zb(10,10),LOAmp(-6:6,-6:6,1:2),decay_amp(1:2)
...
! s-channel 
! MARKUS: changed MomExt(1:4, inLeft/inRight) to all outgoing
SUBROUTINE EvalAmp_QQB_TBARHB(MomExt,TopDecays,LO_Res_Unpol)
implicit none
integer :: TopDecays! 0=stable, 1=di-leptonic
real(8) :: MomExt(1:4,1:9),MomExtFlat(1:7,1:4),p4Dp5,p4Dp7,LO_Res_UnPol(-6:6,-6:6),s(10,10),p2Dp3,MomExtFlatDK(1:10,1:4)
complex(8) :: za(10,10),zb(10,10),LOAmp(-6:6,-6:6,1:2),decay_amp(1:2)
