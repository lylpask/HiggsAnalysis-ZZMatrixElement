...
void get_PAvgProfile_JHUGen_JJVBF_HSMHIggs_8TeV(){
  int erg_tev=8;
  float mPOLE=125.;
  ...
  TFile* foutput = new TFile("pAvg_JHUGen_JJVBF_HSMHIggs_8TeV.root", "recreate");
...
/* SPECIFIC COMMENT: NONE */
void get_PAvgProfile_JHUGen_JVBF_HSMHIggs_8TeV(){
  int erg_tev=8;
  float mPOLE=125.;
  TString TREE_NAME = "SelectedTree";
  bool writeFinalTree=false;
  ...
  TFile* foutput = new TFile("pAvg_JHUGen_JVBF_HSMHIggs_8TeV.root", "recreate");
...
void get_PAvgProfile_JHUGen_JJQCD_HSMHIggs_8TeV(){
  int erg_tev=8;
  float mPOLE=125.;
  TString TREE_NAME = "SelectedTree";
  bool writeFinalTree=false;
  ...
  TFile* foutput = new TFile("pAvg_JHUGen_JJQCD_HSMHIggs_8TeV.root", "recreate");
...
void get_PAvgProfile_JHUGen_JQCD_HSMHIggs_8TeV(){
  int erg_tev=8;
  float mPOLE=125.;
  TString TREE_NAME = "SelectedTree";
  bool writeFinalTree=false;
  ...
  TFile* foutput = new TFile("pAvg_JHUGen_JQCD_HSMHIggs_8TeV.root", "recreate");
